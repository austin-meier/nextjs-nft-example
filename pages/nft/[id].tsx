  ...
  return (
    <div className='flex flex-col h-screen lg:grid lg:grid-cols-10'>
      ...
      <div className='bg-gradient-to-br from-cyan-800 to-rose-500 lg:col-span-4'>
        <div className='flex flex-col items-center justify-between py-2 lg:min-h-screen'>
          ...
          <div className='p-5 space-y-2 text-center'>
            <h1 className='text-4xl font-bold text-white'>
              Austin's Bootleg Test Batch
            </h1>
            <h2 className='text-xl text-gray-300'>A collection of pretty wack images associated to a wallet address once minted.</h2>
          </div>
        </div>
      </div>
      ...
      <div className='flex flex-col flex-1 p-12 lg:col-span-6'>
        ...
        <header className='flex items-center justify-between'>
          <h1 className='text-xl cursor-pointer font-extralight s:w-80 w-52'>
          The <span className='font-extrabold underline decoration-pink-500/50'>Bunz's</span>{' '}Market
          </h1>

          <button
            onClick={() => address ? disconnect() : connectWithMetamask()}
            className='px-4 py-2 font-bold text-white rounded-full bg-rose-400 text-sx lg:px-5 lg:py-3 lg:text-base'
          >
        ...
        <div className='flex flex-col items-center flex-1 mt-10 space-y-6 text-center lg:space-y-0 lg:justify-center'>
          ...
          <h1 className='text-3xl font-bold lg:text-5xl lg:font-extrabold'>wild ass apes | NFT DROP</h1>
